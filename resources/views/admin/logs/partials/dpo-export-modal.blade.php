            ...
            <form method="GET" action="{{ route('admin.logs.export') }}" class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="date_from" required value="{{ now()->subMonth()->toDateString() }}"
                            class="w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 px-3 py-2.5 text-sm dark:text-white">
                    </div>
                    <div>
