            ...
            <div class="card p-0 overflow-hidden bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl md:rounded-3xl shadow-sm">
                ...
                @if($slides->isEmpty())
                    <div class="text-center py-12 md:py-16 px-4 space-y-4">
                        <div class="w-16 h-16 bg-slate-50 dark:bg-slate-800 text-slate-400 dark:text-slate-500 border border-slate-100 dark:border-slate-700 rounded-3xl flex items-center justify-center mx-auto text-2xl" aria-hidden="true">🖼️</div>
                        <div>
        ...
        Alpine.data('carouselAdmin', (config = {}) => ({
            ...
            init() {
                ...
                this.$watch('mobileSidebar', (open) => {
                    if (open) this.openAddSlideModal = false;
                });
            },
