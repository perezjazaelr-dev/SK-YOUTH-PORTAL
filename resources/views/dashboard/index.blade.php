        ...
        <div class="p-6 md:p-8 space-y-8 flex-1 overflow-y-auto font-sans">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <a href="{{ route('dashboard.profiling.index') }}"
                   class="card text-left p-5 flex flex-col justify-between transition-all duration-200 cursor-pointer border border-slate-100 hover:border-blue-200 hover:shadow-md active:scale-98 bg-white rounded-3xl">
                    <div class="flex items-center justify-between">
                        <x-category-icon name="users" class="w-5 h-5 text-[#1e40af]" />
                ...
                <a href="{{ route('dashboard.profiling.index', ['classification' => 'ISY']) }}"
                   class="card text-left p-5 flex flex-col justify-between transition-all duration-200 cursor-pointer border border-slate-100 hover:border-blue-200 hover:shadow-md active:scale-98 bg-white rounded-3xl">
                    <div class="flex items-center justify-between">
                        <x-category-icon name="education" class="w-5 h-5 text-[#1e40af]" />
                ...
                <a href="{{ route('dashboard.profiling.index', ['classification' => 'OSY']) }}"
                   class="card text-left p-5 flex flex-col justify-between transition-all duration-200 cursor-pointer border border-slate-100 hover:border-blue-200 hover:shadow-md active:scale-98 bg-white rounded-3xl">
                    <div class="flex items-center justify-between">
                        <x-category-icon name="active-citizenship" class="w-5 h-5 text-[#1e40af]" />
                ...
                <a href="{{ route('dashboard.profiling.index', ['classification' => 'WY']) }}"
                   class="card text-left p-5 flex flex-col justify-between transition-all duration-200 cursor-pointer border border-slate-100 hover:border-blue-200 hover:shadow-md active:scale-98 bg-white rounded-3xl">
                    <div class="flex items-center justify-between">
                        <x-category-icon name="youth-employment" class="w-5 h-5 text-[#1e40af]" />
                ...
                <a href="{{ route('dashboard.profiling.index', ['sk_voter' => 1]) }}"
                   class="card p-5 bg-gradient-to-br from-blue-700 to-indigo-900 text-white flex flex-col justify-between shadow-sk rounded-3xl hover:shadow-lg transition duration-200">
                    <div class="flex items-center justify-between">
                        <x-category-icon name="governance" class="w-5 h-5 text-blue-200" />
                        <span class="text-[9px] font-black uppercase text-blue-300 tracking-wider">SK Voters</span>
                    </div>
                    <div class="mt-4">
                        <span class="block text-2xl font-black font-display text-white">{{ $totalSkVoters }}</span>
                        <span class="text-[10px] font-bold text-blue-200 uppercase tracking-wider">Registered Voters</span>
                    </div>
                </a>
            </div>
