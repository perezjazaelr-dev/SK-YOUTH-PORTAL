            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="card p-5 bg-white border border-slate-100 rounded-3xl shadow-sm flex flex-col justify-between hover:shadow-md transition font-display">
                    <div class="flex items-center justify-between text-slate-400 font-sans">
                        ...
                        <x-category-icon name="logs" class="w-4 h-4 text-slate-400" />
                    </div>
                ...
                <div class="card p-5 bg-white border border-slate-100 rounded-3xl shadow-sm flex flex-col justify-between hover:shadow-md transition font-display">
                    <div class="flex items-center justify-between text-amber-500 font-sans">
                        <span class="text-[9px] font-black uppercase tracking-wider">Pending Review</span>
                        <x-category-icon name="logs" class="w-4 h-4 text-amber-500" />
                    </div>
                    <div class="mt-3 font-sans">
                        <span class="block text-xl font-black font-display text-amber-600" x-text="stats[activeTab].pending"></span>
                        <span class="text-[9px] font-bold text-slate-450 uppercase tracking-wider">Action Required</span>
                    </div>
                </div>

                <!-- Approved / Completed Card -->
                <div class="card p-5 bg-white border border-slate-100 rounded-3xl shadow-sm flex flex-col justify-between hover:shadow-md transition font-display">
                    <div class="flex items-center justify-between text-emerald-500 font-sans">
                        <span class="text-[9px] font-black uppercase tracking-wider">Approved / Active</span>
                        <x-category-icon name="logs" class="w-4 h-4 text-emerald-500" />
                    </div>
                    <div class="mt-3 font-sans">
                        <span class="block text-xl font-black font-display text-emerald-600" x-text="stats[activeTab].approved"></span>
                        <span class="text-[9px] font-bold text-slate-450 uppercase tracking-wider">Completed / Scheduled</span>
                    </div>
                </div>
            ...
            <div class="space-y-4">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-200">
                    ...
                    <div class="flex overflow-x-auto whitespace-nowrap scrollbar-none text-xs font-bold uppercase tracking-wider">
                        ...
                        @foreach($initiatives as $init)
                            @if($init->form_route === 'forms.sports.create')
                                @continue
                            @endif
                            @php
