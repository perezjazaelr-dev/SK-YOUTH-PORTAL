...
<div x-data="{ mobileSidebar: false }" class="flex-1 flex flex-col md:flex-row bg-[#f8fafc]">
    ...
    <aside :class="mobileSidebar ? 'translate-x-0' : '-translate-x-full md:translate-x-0'"
           class="fixed md:static inset-y-0 left-0 w-80 bg-white border-r border-slate-100 z-30 transition-transform duration-300 transform flex flex-col justify-between shrink-0 shadow-sm md:shadow-none">
                ...
                <div class="card p-0 bg-white border border-slate-100 rounded-3xl overflow-hidden shadow-sm">
                    @if($activeInitiative->accomplishmentReports->isEmpty())
                        <div class="text-center py-12 px-4 space-y-3 bg-white">
                            <div class="w-14 h-14 bg-slate-50 border border-slate-100 rounded-2xl flex items-center justify-center mx-auto text-xl text-slate-400">
                                📂
                            </div>
                            <div>
